...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn("sticky inset-x-0 top-30 z-40 w-full", className)}
    >
    ...
    >
      {items.map((item, idx) => (
        <a
          ...
          onClick={onItemClick}
          className="relative px-4 py-2 text-lg text-neutral-600 dark:text-neutral-300"
          key={`link-${idx}`}
          href={item.link}
        >
          {hovered === idx && (
...
export const NavbarLogo = () => {
  return (
    ...
    >
      <img src="\logo_hima.png" alt="logo" width={30} height={30} />
